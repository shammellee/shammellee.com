...
(function(){$(function(){var s,e,o,t,a,n,i,r,l,d,c,f,u,C,v,p,h;return s=$("#benefitsAndTools"),e=$("#businessRewards"),o=$("#legalContainer"),t=$(".sideNav"),a=t.find("li"),r="contract",l="expand",d="easeInOutExpo",c=parseInt(o.prev().css("border-bottom-width"),10),f="active",u="fixed",C=t.outerHeight(),v="lowerBound",p=68,h=0,t.find("a").click(function(s){return s.preventDefault(),i($($(this).attr("href")))}),i=function(s){var e;return s&&s instanceof $&&(e=s.offset().top,$(window).scrollTop()!==e)?$("html,body").animate({scrollTop:e},1500,d):void 0},$(window).scroll(function(){var i;return i=$(this).scrollTop(),e.offset().top-h<=i&&i<=o.offset().top-c-C?t.removeClass(v).addClass(u):t.hasClass(u||t.hasClass(v))&&t.removeClass(u+" "+v),i>o.offset().top-c-C-p&&t.removeClass(u).addClass(v),n(i<s.offset().top-h?a.eq(0):a.eq(1))}),n=function(s){return a.removeClass(f),null!=s?s.addClass(f):void 0},$(".accordionHead").click(function(){var s;return $(this).parent().find(".accordionContentContainer[data-section_id='"+$(this).data("section_id")+"']").slideToggle(1e3,"easeOutExpo"),s=$(this).find(".accordionIcon"),s.hasClass(l)?s.removeClass(l).addClass(r):s.removeClass(r).addClass(l)})})}).call(this);